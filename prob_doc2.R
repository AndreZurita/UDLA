...
reg1 <- lm(deficit_m ~ score_ctrl, data=completa)
reg1.res = resid(reg1)
summary(reg1) #Beta 0: -5.6602192, Beta 1:0.0154483
...
plot(completa$pago_mens, reg2.res, 
     ylab="Residuals", xlab="PAgo", 
     main="Pago Real vs Predicho")   
abline(0, 0)


#Beca

plot(completa$beca_p, reg3.res, 
     ylab="Residuals", xlab="Beca", 
     main="Beca Real vs Predicho")   
abline(0, 0)
